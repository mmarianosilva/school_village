...
class SchoolAlert {
  ...
  SchoolAlert.fromMap(String id,String path,Map<String, dynamic>  dataMap) : this(
    id,
    path,
    dataMap["title"],
    dataMap["body"],
    DateTime.fromMillisecondsSinceEpoch(dataMap["createdAt"]),
    dataMap["endedAt"] != null ? DateTime.fromMicrosecondsSinceEpoch(dataMap["endedAt"].microsecondsSinceEpoch) : null,
    dataMap["createdBy"],
    dataMap["createdById"],
    LocationData.fromMap(Map<String, double>.from(dataMap["location"])),
    dataMap["type"],
    dataMap["reportedByPhone"],
    dataMap["resolution"],
    resolved: dataMap["endedAt"] != null,
