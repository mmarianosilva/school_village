      ...
      children: <Widget>[
        ...
        new RichText(
          ...
          text: new TextSpan(
            ...
            style: TextStyle(fontSize: 14.0,color: Colors.white),
            children: <TextSpan>[
              new TextSpan(text: '\nBULLYING\nTHREATS\nASSAULT\nSEXUAL HARRASSMENT\nSAFETY ISSUES', style: TextStyle(fontWeight: FontWeight.bold))
            ],
          ),
        ),
        new RichText(
          text: new TextSpan(
            ...
            children: <TextSpan>[
              ...
              new TextSpan(text: ' want someone  to contact  you  back,', style: new TextStyle(fontWeight: FontWeight.bold)),
        ...
        new RichText(
          text: new TextSpan(
            ...
            children: <TextSpan>[
              ...
              new TextSpan(text: ' puede hacer una diferencia en la seguridad de su escuela. Aquí puede informar anónimamente:'),
            ],
          ),
        ),
        new RichText(
          ...
          text: new TextSpan(
            ...
            style: TextStyle(fontSize: 14.0,color: Colors.white),
            children: <TextSpan>[
              new TextSpan(text: '\nACOSO\nAMENAZAS\nASALTO\nHARRASSMENT SEXUAL \nPROBLEMAS DE SEGURIDAD', style: TextStyle(fontWeight: FontWeight.bold))
            ],
          ),
        ),
        new RichText(
          text: new TextSpan(
            ...
            children: <TextSpan>[
              ...
              new TextSpan(text: ' que alguien se ponga en contacto con usted,', style: new TextStyle(fontWeight: FontWeight.bold)),
              new TextSpan(text: ' simplemente incluya su número de teléfono o dirección de correo electrónico en su texto'),
