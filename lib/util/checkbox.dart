...
class SVCheckboxListTile extends StatelessWidget {
  ...
  /// and rebuild the checkbox tile with a [value] to update the visual
  ...
  ///
  /// The checkbox passes the value to the callback but does not actually
  ...
  Widget build(BuildContext context) {
    final Widget control = Checkbox(
      value: value,
      onChanged: onChanged,
      activeColor: SVColors.talkAroundBlue,
    );
